...
var r2 = require('r2');
var WaitForSentry = /** @class */ (function (_super) {
    __extends(WaitForSentry, _super);
    function WaitForSentry() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    WaitForSentry.prototype.emit = function (answers) {
                                        ...
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                                                    ...
                                                    return [4 /*yield*/, r2.get(baseUrl + "api/0/wizard/" + answers.hash + "/")
                                                            .response];
                                                case 1:
                                                    response = _a.sent();
                                                ...
                                                case 2:
                                                    ...
                                                    return [4 /*yield*/, r2.delete(baseUrl + "api/0/wizard/" + answers.hash + "/")];
                                                case 3:
                                                    // Delete the wizard hash since we were able to fetch the data
                                                    _a.sent();
