...
var ReactNative = /** @class */ (function (_super) {
                                    ...
                                    promises = this.getPlatforms(answers).map(function (platform) { return __awaiter(_this, void 0, void 0, function () {
                                        ...
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                ...
                                                case 1:
                                                    _a.sent();
                                                    return [4 /*yield*/, File_1.patchMatchingFile('**/AppDelegate.m', this.patchAppDelegate.bind(this))];
                                                case 2:
                                                    _a.sent();
                                                    return [3 /*break*/, 5];
                                                case 3: return [4 /*yield*/, File_1.patchMatchingFile('**/app/build.gradle', this.patchBuildGradle.bind(this))];
                                                case 4:
                                                    _a.sent();
                                                    _a.label = 5;
                                                case 5: return [4 /*yield*/, File_1.patchMatchingFile("index." + platform + ".js", this.patchJs.bind(this), answers, platform)];
                                                case 6:
                                                    _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, File_1.patchMatchingFile('**/AppDelegate.m', this.unpatchAppDelegate.bind(this))];
                    case 2:
                        _a.sent();
    ...
    ReactNative.prototype.shouldConfigurePlatform = function (platform) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (!File_1.matchesContent('**/AppDelegate.m', /RNSentry/gi)) {
                    result = true;
    ...
    ReactNative.prototype.patchBuildGradle = function (contents) {
        var applyFrom = 'apply from: "../../node_modules/react-native-sentry/sentry.gradle"';
    ...
    ReactNative.prototype.unpatchBuildGradle = function (contents) {
        return Promise.resolve(contents.replace(/^\s*apply from: ["']..\/..\/node_modules\/react-native-sentry\/sentry.gradle["'];?\s*?\r?\n/m, ''));
    };
    // IOS -----------------------------------------
    ...
    ReactNative.prototype.addZLibToXcode = function (proj) {
    ...
    ReactNative.prototype.patchAppDelegate = function (contents) {
        ...
        // add root view init.
        var rootViewMatch = contents.match(/RCTRootView\s*\*\s*([^\s=]+)\s*=\s*\[/);
        if (rootViewMatch) {
            var rootViewInit_1 = '[RNSentry installWithRootView:' + rootViewMatch[1] + '];';
            if (contents.indexOf(rootViewInit_1) < 0) {
                contents = contents.replace(/^(\s*)RCTRootView\s*\*\s*[^\s=]+\s*=\s*\[([^]*?\s*\]\s*;\s*$)/m, function (match, indent) { return match.trim() + '\n' + indent + rootViewInit_1 + '\n'; });
            }
        }
        return Promise.resolve(contents);
    };
    ...
    ReactNative.prototype.unpatchAppDelegate = function (contents) {
        return Promise.resolve(contents
