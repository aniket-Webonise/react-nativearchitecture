...
var BaseIntegration = /** @class */ (function (_super) {
    ...
    function BaseIntegration(argv) {
        var _this = _super.call(this, argv) || this;
        _this.argv = argv;
        _this.type = _this.constructor.name;
        return _this;
    }
    BaseIntegration.prototype.uninstall = function (answers) {
     ...
     */
    BaseIntegration.prototype.shouldConfigure = function (answers) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    BaseIntegration.prototype.shouldEmit = function (answers) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        _b = (_a = _).keys;
                        _d = (_c = _).pickBy;
                        return [4 /*yield*/, this.shouldConfigure(answers)];
                    case 1: return [2 /*return*/, (_b.apply(_a, [_d.apply(_c, [_e.sent(), function (active) { return active; }])])
                            .length > 0)];
                }
            });
        });
