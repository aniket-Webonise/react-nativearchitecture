...
var opn = require('opn');
var r2 = require('r2');
var OpenSentry = /** @class */ (function (_super) {
    __extends(OpenSentry, _super);
    function OpenSentry() {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, r2.get(baseUrl + "api/0/wizard/").json];
                    case 3:
                        data = _a.sent();
                    ...
                    case 4:
                        ...
                        BottomBar_1.BottomBar.hide();
                        Logging_1.nl();
                        Logging_1.red("Wizard couldn't connect to " + baseUrl + "\nmake sure the url is correct");
